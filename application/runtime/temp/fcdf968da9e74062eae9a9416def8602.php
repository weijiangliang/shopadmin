<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\shop\public/../application/admin\view\active\activity_list_add.html";i:1534385587;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="weadmin-body">
        <form class="layui-form" action="<?php echo url('admin/active/activity_list_add'); ?>" enctype="multipart/form-data" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                   <input class="layui-input" placeholder="活动开始时间" name="start_time" id="start">
          </div>
            </div>
            <div class="layui-form-item">
                <label for="vip_name" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    ...
                    <input class="layui-input" placeholder="活动结束时间" name="end_time" id="end">
                </div>
            </div>
           <div class="layui-form-item">
                <label for="vip_id" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="file" id="vip_id" name="thumb" autocomplete="off" class="layui-input">
                </div>
            <div class="layui-form-item">
                </label>
