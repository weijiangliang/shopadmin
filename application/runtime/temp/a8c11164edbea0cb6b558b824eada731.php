<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\shop\public/../application/admin\view\product\product_list_edit.html";i:1533223740;}*/ ?>
<!DOCTYPE html>
<html>

<head>
    <meta charset="UTF-8">
    <title>XXXX后台管理系统-商品列表编辑</title>
        ...
        <form class="layui-form">
            <div class="layui-form-item">
                <label for="product_id" class="layui-form-label">
                    <span class="we-red">*</span>商品ID
                </label>
                <div class="layui-input-inline">
                    <input type="text" id="product_id" name="product_id" lay-verify="required|nikename" autocomplete="off" class="layui-input" value="1001">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="product_name" name="product_name" lay-verify="required|nikename" autocomplete="off" class="layui-input" value="短裤短袖">
                </div>
            </div>
            <div class="layui-form-item">
