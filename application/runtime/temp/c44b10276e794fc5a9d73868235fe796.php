<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\shop\public/../application/admin\view\admin\admin_list_add.html";i:1534229170;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <form class="layui-form" action="<?php echo url('admin/admin/admin_list_add'); ?>" method="post">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="1">男
                  <input type="radio" id="user_phone" name="admin_sex" required="" lay-verify="phone"
                  autocomplete="off" class="layui-input" value="2">女
              </div>
          </div>
          <div class="layui-form-item">
