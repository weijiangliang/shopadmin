<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\shop\public/../application/admin\view\admin\admin_list_add.html";i:1534471785;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    <div class="weadmin-body">
        <form class="layui-form" action="<?php echo url('admin/admin/admin_list_add'); ?>" method="post">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="radio" id="user_phone" name="admin_sex"   value="1" style="display: inline-block;">男
                  <input type="radio" id="user_phone" name="admin_sex"   value="2" style="display: inline-block;">女
              </div>
          </div>
          <div class="layui-form-item">
