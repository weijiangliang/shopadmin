<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\shop\public/../application/admin\view\admin\admin_list_edit.html";i:1534232214;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="weadmin-body">
        ...
        <input type="hidden" name="admin_id" value="<?php echo $admin['admin_id']; ?>">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="radio" id="user_phone" name="admin_sex" required="" lay-verify="phone"
                  autocomplete="off" class="layui-input" value="1" <?php if($admin['admin_sex']==1): ?> checked="1" <?php endif; ?>>男
                  <input type="radio" id="user_phone" name="admin_sex" required="" lay-verify="phone"
                  autocomplete="off" class="layui-input" value="2" <?php if($admin['admin_sex']==2): ?> checked="1" <?php endif; ?>>女
              </div>
          </div>
          <div class="layui-form-item">
