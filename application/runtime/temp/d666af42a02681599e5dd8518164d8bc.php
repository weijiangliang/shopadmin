<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\shop\public/../application/admin\view\user\member_grade_edit.html";i:1533715068;}*/ ?>
<!DOCTYPE html>
<html>

<head>
    <meta charset="UTF-8">
    <title>XXXX后台管理系统-添加会员等级</title>
...
<body>
    <div class="weadmin-body">
        <form class="layui-form" method="post" action="<?php echo url('admin/User/member_editlevel'); ?>">
        <input type="hidden" name="level_id" value="<?php echo $level['level_id']; ?>">
            <div class="layui-form-item">
                <label for="vip_id" class="layui-form-label">
					<span class="we-red">*</span>会员等级名称
				</label>
                <div class="layui-input-inline">
                    <input type="text" id="vip_id" name="level_name" lay-verify="required|nikename" autocomplete="off" class="layui-input" value="<?php echo $level['level_name']; ?>">
                </div>
            ...
            <div class="layui-form-item">
                <label for="vip_name" class="layui-form-label">
					<span class="we-red">*</span>等级描述
				</label>
                <div class="layui-input-inline">
                    <input type="text" id="" name="describe" lay-verify="required|nikename" autocomplete="off" class="layui-input" value="<?php echo $level['describe']; ?>">
                </div>
            </div>
