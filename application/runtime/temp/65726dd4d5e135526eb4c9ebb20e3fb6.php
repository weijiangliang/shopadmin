<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\shop\public/../application/admin\view\coupon\coupon_user_add.html";i:1534765039;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="weadmin-body">
        <form class="layui-form" action="<?php echo url('admin/Coupon/coupon_user_add'); ?>" method="post">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                   ...
                   <option  value="<?php echo $v['id']; ?>"><?php echo $v['coupon_name']; ?></option>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 400px;">
                 <select name='user_id' style="display: inline-block;  width: 150px;height: 35px;" id="goods"  multiple="multiple" size="5">
                   ...
                   <option  value="<?php echo $vol['user_id']; ?>"><?php echo $vol['user_id']; ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
