<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\shop\public/../application/admin\view\product\product_list_add.html";i:1534121379;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="proAdd">
        <div class="layui-tab layui-tab-card">
            ...
            <li><a href="<?php echo url('admin/product/product_list_add'); ?>">商品基本信息</a></li>
            </ul>
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    ...
                    <form action="<?php echo url('admin/product/product_list_add'); ?>" enctype="multipart/form-data" method="post">
                  ...
                  $("#cate_two_id").change(function(){
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                ...
                                <?php if(is_array($brand) || $brand instanceof \think\Collection || $brand instanceof \think\Paginator): if( count($brand)==0 ) : echo "" ;else: foreach($brand as $key=>$vol): ?>
                                    <option value="<?php echo $vol['id']; ?>"><?php echo $vol['brand_name']; ?></option>
                               <?php endforeach; endif; else: echo "" ;endif; ?>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                ...
                                <?php if(is_array($suppfilers) || $suppfilers instanceof \think\Collection || $suppfilers instanceof \think\Paginator): if( count($suppfilers)==0 ) : echo "" ;else: foreach($suppfilers as $key=>$vl): ?>
                                    <option value="<?php echo $vl['suppliers_id']; ?>"><?php echo $vl['suppliers_name']; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
