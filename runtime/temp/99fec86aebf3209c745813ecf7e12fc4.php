<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\shop\public/../application/admin\view\gift\gift_mall_add.html";i:1534836526;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="layui-unselect layui-form-select downpanel cs">
                ...
                <dl class="layui-anim layui-anim-upbit" style="">
                   <?php if(is_array($goods) || $goods instanceof \think\Collection || $goods instanceof \think\Paginator): if( count($goods)==0 ) : echo "" ;else: foreach($goods as $key=>$vol): ?>
                    <dd><input type="checkbox" name="brand[]" title="<?php echo $vol['good_name']; ?>" value="<?php echo $vol['good_id']; ?>" lay-skin="primary" style="display:none"></dd>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </dl>
            </div>
           </div>
             ...
             <!--   <div class="layui-form-item">
                <label for="vip_id" class="layui-form-label">
					<span class="we-red">*</span>所属商品id
				</label>
                <div class="layui-input-inline">
                 <textarea class="textarea" name="good_ids" value="字符串多个用英文逗号隔开"> </textarea>
                </div>
            </div> -->
            <div class="layui-form-item">
                </label>
