<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"E:\shop\public/../application/admin\view\user\member_grade.html";i:1534412655;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <div class="weadmin-body">
        <div class="weadmin-block">
            <a class="layui-btn"
            onclick="WeAdminShow('会员列表编辑','member_grade_add.html',1000,600)"
             ><i class="layui-icon"></i>添加会员等级</a>
        ...
        <table class="layui-table">
            ...
            <?php if(is_array($level) || $level instanceof \think\Collection || $level instanceof \think\Paginator): if( count($level)==0 ) : echo "" ;else: foreach($level as $key=>$v): ?>
                <tr>
                    ...
                    <td>
                        <a title="编辑"   onclick="WeAdminShow('会员列表编辑','member_editlevel.html?id=<?php echo $v['level_id']; ?>',1000,600)">
