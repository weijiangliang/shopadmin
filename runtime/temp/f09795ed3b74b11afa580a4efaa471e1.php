<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\shop\public/../application/admin\view\user\member_grade_add.html";i:1533713478;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="weadmin-body">
        <form class="layui-form" method="post" action="<?php echo url('admin/User/member_grade_add'); ?>">
            <div class="layui-form-item">
                <label for="vip_id" class="layui-form-label">
					<span class="we-red">*</span>会员等级名称
				</label>
                <div class="layui-input-inline">
                    <input type="text" id="vip_id" name="level_name" lay-verify="required|nikename" autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="" name="describe" lay-verify="required|nikename" autocomplete="off" class="layui-input">
                </div>
            </div>
