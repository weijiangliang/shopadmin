<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"E:\shop\public/../application/admin\view\user\member_list.html";i:1533714386;}*/ ?>
<!DOCTYPE html>
<html>
			...
			<div class="layui-row">
				<form class="layui-form layui-col-md12 we-search">
					...
					<div class="layui-inline">
						<input class="layui-input" placeholder="加入会员开始时间" name="start" id="start">
					</div>
					<div class="layui-inline">
						<input class="layui-input" placeholder="加入会员结束时间" name="end" id="end">
					</div>
					<div class="layui-inline">
						<input type="text" name="vip_name" placeholder="请输入会员名" autocomplete="off" class="layui-input">
					</div>
