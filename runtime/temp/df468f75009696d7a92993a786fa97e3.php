<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\shop\public/../application/admin\view\gift\gift_list_add.html";i:1534821615;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="weadmin-body">
        <form class="layui-form" enctype="multipart/form-data" action="<?php echo url('admin/Gift/gift_list_add'); ?>"  method="post">
            <div class="layui-form-item">
                <label for="vip_id" class="layui-form-label">
					<span class="we-red">*</span>礼包名称
				</label>
                <div class="layui-input-inline">
                    <input type="text" id="vip_id" name="name" lay-verify="required|nikename" autocomplete="off" class="layui-input">
                </div>
             </div>
            <!--  <div class="layui-form-item">
                <label for="vip_id" class="layui-form-label">
