<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\shop\public/../application/admin\view\active\activity_list_edit.html";i:1534388225;}*/ ?>
<!DOCTYPE html>
<html>

<head>
    <meta charset="UTF-8">
    <title>XXXX后台管理系统-活动列表</title>
...
<body>
    <div class="weadmin-body">
        <form class="layui-form" action="<?php echo url('admin/active/activity_list_edit'); ?>" enctype="multipart/form-data" method="post">
        <input type="hidden" name="id" value="<?php echo $active['id']; ?>"> 
            <div class="layui-form-item">
                <label for="vip_id" class="layui-form-label">
					<span class="we-red">*</span>场次名称
				</label>
                <div class="layui-input-inline">
                    <input type="text" id="vip_id" name="title" lay-verify="required|nikename" autocomplete="off" class="layui-input" value="<?php echo $active['title']; ?>">
                </div>
            ...
            <div class="layui-form-item">
                <label for="vip_name" class="layui-form-label">
					<span class="we-red">*</span>活动开始时间
				</label>
                <div class="layui-input-inline">
                   <input value="<?php echo date('Y-m-d ',$active['start_time']); ?>" class="layui-input" placeholder="活动开始时间" name="start_time" id="start">
          </div>
            </div>
            <div class="layui-form-item">
                <label for="vip_name" class="layui-form-label">
					<span class="we-red">*</span>活动结束时间
				</label>
                <div class="layui-input-inline">
                    
                    <input value="<?php echo date('Y-m-d ',$active['end_time']); ?>" class="layui-input" placeholder="活动结束时间" name="end_time" id="end">
                </div>
            </div>
           <div class="layui-form-item">
                <label for="vip_id" class="layui-form-label">
					<span class="we-red">*</span>场主题图片
				</label>
                <div class="layui-input-inline">
                   <img src="/uploads/<?php echo $active['thumb']; ?>"> <input type="file" id="vip_id" name="thumb" autocomplete="off" class="layui-input">
                </div>
            <div class="layui-form-item">
                </label>
