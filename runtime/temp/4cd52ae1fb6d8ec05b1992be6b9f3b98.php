<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\shop\public/../application/admin\view\coupon\coupon_list_edit.html";i:1534744065;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="weadmin-body">
        <form class="layui-form" action="<?php echo url('admin/Coupon/coupon_list_edit'); ?>"  method="post">
        <input type="hidden" name="id" value="<?php echo $coupon['id']; ?>">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="vip_id" name="coupon_name" lay-verify="required|nikename" autocomplete="off" class="layui-input" value="<?php echo $coupon['coupon_name']; ?>">
                </div>
             </div>
            <!--  <div class="layui-form-item">
                <label for="vip_id" class="layui-form-label">
               ...
               <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="vip_id" name="coupon_money" lay-verify="required|nikename" autocomplete="off" class="layui-input" value="<?php echo $coupon['coupon_money']; ?>">
                </div>
             </div>
               <div class="layui-form-item">
                <label for="vip_id" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="vip_id" name="condition" lay-verify="required|nikename" autocomplete="off" class="layui-input" value="<?php echo $coupon['condition']; ?>">
                </div>
             </div>
               <div class="layui-form-item">
                <label for="vip_id" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="vip_id" name="createnum" lay-verify="required|nikename" autocomplete="off" class="layui-input" value="<?php echo $coupon['createnum']; ?>">
                </div>
             </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                   <input class="layui-input" placeholder="活动开始时间" name="send_start_time" id="start" value="<?php echo date('Y-m-d',$coupon['send_start_time']); ?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label for="vip_name" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                   <input class="layui-input" placeholder="活动开始时间" name="send_end_time" id="end" value="<?php echo date('Y-m-d',$coupon['send_end_time']); ?>">
                </div>
            </div>
               ...
               <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                   <input class="layui-input" placeholder="活动开始时间" name="use_start_time" id="start" value="<?php echo date('Y-m-d',$coupon['use_start_time']); ?>">
                   </div>
            </div>
            <div class="layui-form-item">
                <label for="vip_name" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    ...
                    <input class="layui-input" placeholder="活动结束时间" name="use_end_time" id="end" value="<?php echo date('Y-m-d',$coupon['use_end_time']); ?>">
                </div>
            </div>
