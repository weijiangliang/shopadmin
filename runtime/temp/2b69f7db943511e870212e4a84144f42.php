<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\shop\public/../application/admin\view\active\gift_list_edit.html";i:1534400197;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="weadmin-body">
        <form class="layui-form" action="<?php echo url('admin/Active/gift_list_edit'); ?>" method="post">
        <input type="hidden" name="id" value="<?php echo $activegoods['id']; ?>">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="activity_price" autocomplete="off" value="<?php echo $activegoods['activity_price']; ?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label for="vip_name" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="vip_name" name="vip_activity_price" lay-verify="required|nikename" autocomplete="off" class="layui-input" value="<?php echo $activegoods['vip_activity_price']; ?>">
                </div>
            </div>
            <div class="layui-form-item">
                </label>
